...
<body class="bg-gray-200">
    ...
    <nav id="nav" class="fixed inset-x-0 top-0 flex flex-row justify-between z-10 text-white bg-transparent">
        ...
        <div class="p-4">
            <div class="font-extrabold tracking-widest text-xl"><a href="https://www.instagram.com/retina.photo/"
                    class="transition duration-500 hover:text-indigo-500">Retina.Photo</a></div>
        </div>

        <!-- Nav Items Working on Tablet & Bigger Sceen -->
        <div class="p-4 hidden md:flex flex-row justify-between font-bold">
            <a id="hide-after-click" href="#about"
                class="mx-4 text-lg  border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">About</a>
            <a href="#paket"
                class="mx-4 text-lg border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">Package</a>
            <a href="#showcase"
                class="mx-4 text-lg border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">Portfolio</a>
            <a href="#moreinfo"
                class="mx-4 text-lg border-b-2 border-transparent hover:border-b-2 hover:border-indigo-300 transition duration-500">More
                Info</a>
        </div>
    ...
    <main>
        ...
        <section id="about" class="flex flex-col items-center justify-center bg-light">
            ...
            <div class="flex flex-col md:flex-row rounded overflow-hidden">
                ...
                <div class="mt-1 md:mt-4 m-4 flex self-center flex-col">
                    ...
                    <h1
                        class="font-extrabold text-4xl mt-1 mb-2 mm:my-4 border-b-4 border-indigo-600 self-start leading-tight">
                        {{ $profil->judul }}</h1>
                    <p class="text-lg">{{ $profil->keterangan }}</p>
                    <div class="flex">
                        <button
                            class="p-2 font-bold text-white border-2 border-indigo-700 text-indigo-700 self-start mt-4 rounded mr-2">Read
                            more</button>
                        <a href="#whyus">
                            <button
                                class="flex flex-row p-2 font-bold text-white border-2 border-indigo-700 text-indigo-700 self-start mt-4 rounded">
                                Why Us ?<span><svg class="ml-2 text-indigo-800" xmlns="http://www.w3.org/2000/svg"
        ...
        <section id="paket" style="padding-top:70px; padding-bottom:70px; background-color:white;" id="whyus"
            ...
            @foreach ($data as $item)
                <div class="flex flex-col items-center w-full sm:w-1/2 bg-white p-4">
                    ...
                    <a href="https://api.whatsapp.com/send?phone=628982915090&text={{ urlencode($item->keterangan) }}">
                        <h3
                            class="transition duration-500 hover:text-indigo-500 btn text-4xl font-bold text-black-600">
                            {{ $item->nama_paket }}</h3>
                    </a>
        ...
        <div id="moreinfo" class="flex flex-col sm:flex-row justify-between w-full md:mt-8 md:px-8 my-8">
            ...
            <div class="flex self-center">
                <a href="https://www.instagram.com/retina.photo/" target='_blank'><button
                        class="p-2 font-bold text-white border-2 border-indigo-700 bg-indigo-700 mt-4 rounded w-64">Hire
                        Us!</button></a>
            </div>
        </div>
        ...
        <section id="showcase" class="h-screen bg-white p-4 px-8 flex flex-col justify-center items-center">
            ...
            <div class="owl-carousel owl-theme">
                @foreach ($portofolio as $portofolio)
                    <div class="m-8 shadow-md rounded overflow-hidden"><img
                            data-src="{{ asset('image/' . $portofolio->foto) }}"
                            src="{{ asset('image/' . $portofolio->foto) }}" class="owl-lazy w-full shadow-lg"></div>
                @endforeach
            </div>
        </section>
        ...
        <section id="buy" class="bg-white p-4 px-8">
            ...
            <div class="flex flex-col md:flex-row md:flex-wrap justify-center">
                <div class="flex items-center bg-white p-4">
                    <span
                        class=" border border-indigo-600 text-indigo-600 bg-indigo-100 rounded-tl-full rounded-bl-full p-4">
                    ...
                    <h3
                        class="w-full md:w-auto border border-indigo-600 bg-gray-200 p-4 rounded-tr-full rounded-br-full font-bold text-indigo-700">
                        Hire Us!</h3>
                </div>
                <div class="flex items-center bg-white p-4">
                    <span
            ...
            <div class="flex flex-row justify-center flex-wrap">
                ...
                <div class="m-4 w-full md:w-5/12">
                    <h3 class="font-semibold text-xl text-gray-900">Can we request feature or revision edited photo ?
                    </h3>
    ...
    <footer class="bg-indigo-800 text-white font-semibold p-4">
        <div class="flex flex-col md:flex-row justify-between">
            <div class="flex flex-col w-full my-4 md:w-1/3">
                <div class="my-2 inline-flex"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" width="24"
            ...
            <div class="flex flex-col w-full my-4 md:w-1/3">
                ...
                <a href="{{ route('login') }}"><i class="fa fa-cog"></i></a>
            </div>
            <div class="flex flex-col w-full my-4 md:w-1/3">
                <form>
                    <input type="text"
                        class="text-indigo-700 font-bold focus:outline-none focus:border-indigo-700 p-2 border border-indigo-600"
                        placeholder="name@mail.io">
                    <button
                        class="bg-white p-2 font-bold text-indigo-700 border-2 border-indigo-700 focus:outline-none">Go</button>
                </form>

            </div>
        </div>
    </footer>
    <a href="#up" class="rounded-full fixed bottom-0 right-0 p-2 m-2 bg-black text-indigo-700 font-bold"><svg
    ...
    <div class="text-lg bg-indigo-900 text-white font-bold text-center py-1"> &copy; 2021 by Aditya | Dhenis | Yoga
    </div>
