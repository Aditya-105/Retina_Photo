                    ...
                    <div class="card">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form role="form" method="post" action="{{ url('paket/add') }}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label"><i class="fa fa-info-circle mr-1"></i> Whatsapp</label>
                                                        <div class="col-sm-10">
                                                            <textarea rows="5" cols="5" class="form-control" name="keterangan" placeholder="Masukkan Keterangan Paket"></textarea>
                                                        </div>
                                                    </div>
                        ...
                        <div class="card-block">
                            <div class="dt-responsive table-responsive">
                                <table id="multi-column-dt" class="table table-striped table-bordered dataTable"
